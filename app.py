...
if app_mode == "Prediction Tool":
    ...
    def prepare_features():
        ...
        feature_dict = {
            ...
            'pickup_borough_Brooklyn': 1 if pickup_location == 'Brooklyn' else 0,
            'pickup_borough_Queens': 1 if pickup_location == 'Queens' else 0,
            'pickup_borough_Bronx': 1 if pickup_location == 'Bronx' else 0,
            'pickup_borough_Staten Island': 1 if pickup_location == 'Staten Island' else 0,
            'pickup_borough_JFK Airport': 1 if pickup_location == 'JFK Airport' else 0,
            'pickup_borough_LaGuardia Airport': 1 if pickup_location == 'LaGuardia Airport' else 0,
            'pickup_borough_Newark Airport': 1 if pickup_location == 'Newark Airport' else 0,
            'dropoff_borough_Manhattan': 1 if dropoff_location == 'Manhattan' else 0,
            'dropoff_borough_Brooklyn': 1 if dropoff_location == 'Brooklyn' else 0,
            'dropoff_borough_Queens': 1 if dropoff_location == 'Queens' else 0,
            'dropoff_borough_Bronx': 1 if dropoff_location == 'Bronx' else 0,
            'dropoff_borough_Staten Island': 1 if dropoff_location == 'Staten Island' else 0,
            'dropoff_borough_JFK Airport': 1 if dropoff_location == 'JFK Airport' else 0,
            'dropoff_borough_LaGuardia Airport': 1 if dropoff_location == 'LaGuardia Airport' else 0,
            'dropoff_borough_Newark Airport': 1 if dropoff_location == 'Newark Airport' else 0
        }
